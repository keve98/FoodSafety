...
public class PoultryRoastingWebElement extends FoodSafetyWebElement {
    ...
    public PoultryRoastingWebElement(String foodCategory, String foodType, String ovenTemperatureInFInformation, String timingInformation) {
        FoodCategory = foodCategory;
        FoodType = foodType;
        OvenTemperatureInFInformation = ovenTemperatureInFInformation;
        TimingInformation = timingInformation;
        Type = FoodSafetyType.PoultryRoasting;
    }
}
